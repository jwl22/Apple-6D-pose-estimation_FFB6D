...
class Config:
    def __init__(self, ds_name="ycb", cls_type=""):
        ...
        self.noise_trans = (
            0.05  # range of the random noise of translation added to the training data
        )
        ...
        if self.dataset_name == "ycb":
            ...
            self.ycb_cls_lst_p = os.path.abspath(
                os.path.join(self.exp_dir, "datasets/ycb/dataset_config/classes.txt")
            )
            self.ycb_root = os.path.abspath(
                os.path.join(self.exp_dir, "datasets/ycb/YCB_Video_Dataset")
            )
            self.ycb_kps_dir = os.path.abspath(
                os.path.join(self.exp_dir, "datasets/ycb/ycb_kps/")
            )
            ycb_r_lst_p = os.path.abspath(
                os.path.join(self.exp_dir, "datasets/ycb/dataset_config/radius.txt")
            )
            ...
            self.lm_r_lst = yaml.full_load(lm_r_file)
